...
pub struct CanNetworkManager {
    can_network_manager: isobus::isobus_CANNetworkManager
...
// 		static CANNetworkManager CANNetwork; ///< Static singleton of the one network manager. Use this to access stack functionality.
	...
	// pub fn on_partner_deleted(PartneredControlFunction *partner, CANLibBadge<PartneredControlFunction>) {
