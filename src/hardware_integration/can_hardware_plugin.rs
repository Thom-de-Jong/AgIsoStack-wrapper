//================================================================================================
/// @file can_hardware_plugin.rs
///
/// @brief The main trait for a CAN driver. Can be derived into your platform's required interface.
/// @author Thom de Jong
///
...
pub trait CanHardwarePluginTrait {
	...
	/// @returns `Some` if a CAN frame was read, otherwise `None`
	fn read_frame(&mut self) -> Option<HardwareInterfaceCanFrame>;

	/// @brief Writes a frame to the bus (synchronous)
	/// @param[in] can_frame The frame to write to the bus
