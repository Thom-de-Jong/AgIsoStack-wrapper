//================================================================================================
/// @file can_hardware_interface.rs
///
...
// pub trait CANHardwareInterface {
// 	fn get_number_of_can_channels() -> u8;
// 	fn set_number_of_can_channels(value: u8) -> bool;
// 	fn assign_can_channel_frame_handler(aCANChannel: u8, *canDriver: CanHardwarePlugin) -> bool;
// 	fn start() -> bool;
// 	fn stop() -> bool;
// 	fn transmit_can_message(isobus::HardwareInterfaceCANFrame &packet) -> bool;
// 	fn add_raw_can_message_rx_callback(void (*callback)(isobus::HardwareInterfaceCANFrame &rxFrame, void *parentPointer), void *parentPointer) -> bool;
// 	fn remove_raw_can_message_rx_callback(void (*callback)(isobus::HardwareInterfaceCANFrame &rxFrame, void *parentPointer), void *parentPointer) -> bool;
// 	fn set_can_driver_update_period(value: u32);
// 	fn add_can_lib_update_callback(void (*callback)(), void *parentPointer) -> bool;
// 	fn remove_can_lib_update_callback(void (*callback)(), void *parentPointer) -> bool;
// }

use super::CanHardwarePluginTrait;
...
pub fn get_number_of_can_channels() -> u8 {
	todo!()
}
...
pub fn set_number_of_can_channels(value: u8) -> bool {
	todo!()
}
...
pub fn assign_can_channel_frame_handler(can_channel: u8, can_driver: &dyn CanHardwarePluginTrait) -> bool {
	todo!()
}
...
// pub fn transmit_can_message(isobus::HardwareInterfaceCANFrame &packet) -> bool;
...
// pub fn add_raw_can_message_rx_callback(void (*callback)(isobus::HardwareInterfaceCANFrame &rxFrame, void *parentPointer), void *parentPointer) -> bool;
...
// pub fn remove_raw_can_message_rx_callback(void (*callback)(isobus::HardwareInterfaceCANFrame &rxFrame, void *parentPointer), void *parentPointer) -> bool;
...
// pub fn set_can_driver_update_period(std::uint32_t value);

// /// @brief Adds a periodic udpate callback
// /// @param[in] callback The callback to add
// /// @param[in] parentPointer Generic context variable, usually a pointer to the owner class for this callback
// /// @returns `true` if the callback was added, `false` if it was already in the list
// pub fn add_can_lib_update_callback(void (*callback)(), void *parentPointer) -> bool;

// /// @brief Removes a periodic update callback
// /// @param[in] callback The callback to remove
// /// @param[in] parentPointer Generic context variable, usually a pointer to the owner class for this callback
// /// @returns `true` if the callback was removed, `false` if no callback matched the two parameters
// pub fn remove_can_lib_update_callback(void (*callback)(), void *parentPointer) -> bool;
